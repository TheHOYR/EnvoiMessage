 ...
 */
public class ChannelAsync extends AsyncTask<Long,Integer, String> {
    ...
    public ChannelAsync(Context myContext, HashMap<String,String> myChannel)
    {
    ...
    {
        return performPostCall("http://www.raphaelbischof.fr/messaging/?function=getchannels", channel);
    }
