...
/**
 * Created by lahouzeb on 20/01/2017.
 */
public class MessageSendAsync extends AsyncTask<Long,Integer, String>
{
    ...
    public MessageSendAsync(Context myContext, HashMap<String,String> myMessage)
    {
    ...
    {
        return performPostCall("http://www.raphaelbischof.fr/messaging/?function=sendmessage", message);
    }
